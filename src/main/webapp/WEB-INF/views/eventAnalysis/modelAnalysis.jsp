...
<body>
		...
		<div class="main">
				...
				<ul class="parentWrap">
					...
					<li><span class="groupTitle"><s class="idx"><img
						...
						<ul class="friends">
							...
							<li><a href="<%=basePath%>rest/backLost/startDayView">流失用户</a>
							</li>
					...
					<li><span class="groupTitle"><s class="idx"><img
							...
							class="fr"></i> </span>
						<ul class="friends">
                            <li><a href="<%=path%>/rest/event/eventView" class="friends-color">模块分析</a></li>
			...
			<div class="content fr">
				...
				<div class="panel panel-default">
					<div class="panel-heading no-collapse gk-title">TOP10模块使用次数</div>
					
					<div class="timeAnaly-u">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="getByDESC" type="button" class="btn-left fl btn-left1">TOP10</button>
                                <div class="line fl"></div>
                                <button id="getByASC" type="button" class="btn-right fl">LAST10</button>
                            </div>
                        </div>
                        <div class="timeAnaly" id="modelUseEchart"></div>
                    </div>
					
				</div>
				<!-- 第二排 -->
				<div class="panel panel-default">
					<div class="panel-heading no-collapse gk-title">模块使用次数</div>
					<table id="queryModelTable" class="table-font table table-striped">
					</table>
				</div>
				<!-- 第二排 -->
			</div>
	...
	<script src="<%=basePath%>js/modelUseAsc.js"></script>
	<script src="<%=basePath%>js/modelUse.js"></script>
	<script type="text/javascript">
		$(".groupTitle").eq(3).next("ul").css("display", "block");
	</script>
</body>
