                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=path%>/rest/UserAndUse/areaDis" class="friends-color">地区分析</a></li>
...
<!--                     <div class="btn-Arrs fl">
                        <button type="button" class="bottuntab_only fl" id="today">中国地区</button>
                    </div> -->
					<!-- Split button -->
					<div class="btn-group">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="timeAnaly-u">
                        ...
                        <div id="distrArea" class="timeChart2">
                        </div>
                    </div>
                </div>
                <!-- 第二排 -->
                <div class="row">
					<div class="col-sm-12 col-md-12">
						<div class="panel panel-default">
							...
							<table id="province" class="table table-striped">
								<thead>
									<tr>
										<td>新增用户比例</td>
										<td class="br"></td>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">省市明细（注：不含港澳台地区）</div>
                    	<table id="example-Ssmx" class="table-font table table-striped">
                    	</table>
                </div>
                <!-- 第二排 -->
            </div>
    ...
    <!-- 用户与使用 -->
    <script src="<%=path%>/js/Users-Dq.js"></script>
    <!-- 日期控件 -->
