...
<body>
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=path%>/rest/UserAndUse/activeAnalysis" class="friends-color">活跃分析</a></li>
            ...
            <div class="content fr">
                    ...
                    <div class="timeAnaly">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="dayActive" type="button" class="btn-left fl">日活跃</button>
                                <div class="line fl"></div>
                                <button id="monthActive" type="button" class="btn-center fl">月活跃</button>
                                <div class="line fl"></div>
                                <button id="dayMonthScale" type="button" class="btn-right fl" style="width:100px;">日活跃/月活跃</button>
                            </div>
                        </div>
                        <div id="actChart" class="timeChart">
                        </div>
                    </div>
                </div>
                <!-- 第二排 -->
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">概况</div>
                            <table id="dauCompareMau" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>日活跃/月活跃</td>
                                        <td>0</td>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">概况</div>
                            <table id="avgActUser" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>用户每月平均活跃人数</td>
                                        <td></td>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">活跃明细</div>
                    	<table id="example-Hymx" class="table-font table table-striped">
                    	</table>
                </div>
                <!-- 第二排 -->
            </div>
    ...
    <!-- 活跃分析 -->
    <script src="<%=path%>/js/Users-Hy.js"></script>
    <!-- 日期控件 -->
