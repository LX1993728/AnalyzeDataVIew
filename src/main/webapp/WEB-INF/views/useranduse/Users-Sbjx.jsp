...
<body>
        ...
        <div class="main">
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=path%>/rest/UserAndUse/equipmentModl" class="friends-color">设备机型</a></li>
            ...
            <div class="content fr">
                ...
                <div class="users-dataTime">
                   ...
                   <!--  bottuntab_leftHover -->
                        <button id="equipmentModel" type="button" class="bottuntab_left fl">机型</button>
                        <div class="line fl"></div>
                        <button id="os" type="button" class="bottuntab_right fl" >操作系统</button>
                    </div>
                    <!-- Split button -->
					<div class="btn-group">
						...
						<div class="dropdown-menu-data fl">
							<div class="dropdown-menu-data-top">
								<a href='javascript:void(0)' onclick='getEchartModelData(this)' value="0">今日</a>| <a href="#"
									...
									href='#' onclick='getEchartModelData(this)' value="30">近30日</a>| <!-- <select name="" id="">
								...
								</select>| --> <a href="#" onclick='getEchartModelData(this)' value="365">近一年</a>
							</div>
                    ...
                    <div class="timeAnaly-u">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="addUser" type="button" class="btn-left fl">新增用户</button>
                                <div class="line fl"></div>
                                <button id="actUser" type="button" class="btn-center fl">活跃用户</button>
                                <div class="line fl"></div>
                                <button id="startTimeBtn" type="button" class="btn-right fl">启动次数</button>
                            </div>
                        </div>
                        <div id="modelTop10" class="timeChart2">
                        </div>
                    </div>
                </div>
                <!-- 第二排 -->
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div id="modelSummary" class="panel-heading no-collapse gk-title">机型摘要</div>
                            <table id="modelSummaryTable" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>30日上升最快机型</td>
                                        <td></td>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div id="hotMod" class="panel-heading no-collapse gk-title">最热机型</div>
                            <table id="hotModel" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>最热机型</td>
                                        <td></td>
               ...
               <div id="modelDeta" class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">机型数据明细</div>
                    	<table id="example-Sbjx" class="table-font table table-striped">
                    	</table>
                </div>
                
                <div id="osDeta" class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">操作系统明细</div>
                    	<table id="example-Sbjx1" class="table-font table table-striped">
                    	</table>
                </div>
                <!-- 第二排 -->
            </div>
    ...
    <script src="<%=path%>/js/Users-Sbjx.js"></script>
