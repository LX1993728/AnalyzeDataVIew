...
<body>
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            <li><a href="<%=path%>/rest/UserAndUse/NewAndStart" class="friends-color">新增和启动</a></li>
            ...
            <div class="content fr">
                    ...
                    <div class="timeAnaly">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                ...
                                <div class="line fl"></div>
                                <button id="startTimeBtn" type="button" class="btn-center fl">启动次数</button>
                                <div class="line fl"></div>
                                <button id="avgUseTime" type="button" class="btn-center fl">平均使用时长</button>
                                <div class="line fl"></div>
                                <button id="userCount" type="button" class="btn-right fl">累计用户</button>
                            </div>
                        </div>
                        <div id="userRough" class="timeChart">
                        </div>
                    </div>
                </div>
                <!-- 第二排 -->
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">数据摘要</div>
                            <table id="tabledeail" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>时段内新增用户</td>
                                        <td></td>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">启动概况（昨日）</div>
                            <table id="timesStartToatal" class="table table-striped">
                                <thead>
                                    <tr>
                                        <td>时段内启动（次数 | 每日人均）</td>
                                        <td></td>
                ...
                <!-- 第三排 -->
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">明细数据</div>
                    	<table id="example1" class="table-font table table-striped">
                   		</table>
				</div>
                <!-- 第四排 -->
            </div>
    ...
    <!-- 新增和启动 -->
    <script src="<%=path%>/js/addAndStart.js"></script>
    <!-- 日期控件 -->
