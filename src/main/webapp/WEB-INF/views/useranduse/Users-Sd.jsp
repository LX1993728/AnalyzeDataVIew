                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=path%>/rest/UserAndUse/timeAnalysis" class="friends-color">时段分析</a></li>
                    ...
                    <div class="timeAnaly">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="startTimeBtn" type="button" class="btn-left fl">启动次数</button>
                                <div class="line fl"></div>
                                <button id="addUsers" type="button" class="btn-right fl">新增用户</button>
                            </div>
                        </div>
...
<!--                     <div class="col-sm-12 col-md-6"> -->
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">高峰时段</div>
                            <table id="highTimeTable" class="table table-striped lf">
                                <thead>
                                    <tr>
                                        <td>繁忙时段</td>
                                    </tr>
...
<!--                     <div class="col-sm-12 col-md-6"> -->
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title">低谷时段</div>
                            <table id="lowTimeTable" class="table table-striped lf">
                                <thead>
                                    <tr>
                                        <td>低谷时段</td>
                                    </tr>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">时段明细</div>
                    	<table id="example-Sdmx" class="table-font table table-striped">
                    	</table>
                </div>
                <!-- 第二排 -->
            </div>
    ...
    <!-- 时段分析-->
    <script src="<%=path%>/js/Users-Sd.js"></script>
    <!-- 日期控件 -->
