...
<body>
        ...
        <div class="main">
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            <li><a href="<%=basePath%>rest/retention/retentionView" class="friends-color">用户留存</a></li>
            ...
            <div class="content fr">
                ...
                <div class="panel panel-default">
					...
					<thead>
						<tr>
							<td class="br" id="retentionRates"></td>
						</tr>
					</thead>
				</table>
                    </div>
                    <div class="timeAnaly">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="oneDay" type="button" class="btn-left fl" >次日留存率</button>
                                <div class="line fl"></div>
                                <button id="sevenDay"  type="button" class="btn-center fl" >7日留存率</button>
                                <div class="line fl"></div>
                                <button id="thirtyDay" type="button" class="btn-right fl" >30日留存率</button>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading no-collapse gk-title" id="retentionGeneral"></div>
                ...
                <!-- 第三排 -->
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title" id="retentionDetail"></div>
    ...
    <script src="<%=basePath%>js/retention.js"></script>
    <script type="text/javascript">
		$(".groupTitle").eq(2).next("ul").css("display", "block");
		//按钮默认被选中的样式
		$("#oneDay").addClass('btn-left1');
	</script>
</body>
</html>
