...
<body>
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=basePath%>rest/returnVisit/returnVisitView" class="friends-color">用户回访</a></li>
            ...
            <div class="content fr">
                    ...
                    <div class="timeAnaly">
                        <div class="timeAnaly-btn">
                            <div class="btn-group1 fl z" role="group">
                                <button id="sevenDay" type="button" class="btn-left fl">7日回访用户</button>
                                <div class="line fl"></div>
                                <button id="userCount" type="button" class="btn-right fl">回访率</button>
                            </div>
                        </div>
                        <div id="visitChart" class="timeChart">
                        </div>
                    </div>
                </div>
                <!-- 第二排 -->
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">
                        ...
                        <table  class="table-font table table-striped" id="newMouth"></table>
                </div>
                <!-- 第三排 -->
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">回访用户明细</div>
    ...
    <script src="<%=basePath%>js/visit.js"></script>
    <script type="text/javascript">
		$(".groupTitle").eq(2).next("ul").css("display", "block");
		//按钮默认被选中的样式
		$("#sevenDay").addClass('btn-left1');
	</script>
</body>
</html>
