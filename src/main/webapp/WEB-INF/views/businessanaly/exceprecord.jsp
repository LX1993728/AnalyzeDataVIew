        ...
        <div class="main">
                ...
                <ul class="parentWrap">
                    ...
                    <li>
                        ...
                        <ul class="friends" style="display: block;">
                            ...
                            <li><a href="<%=path%>/rest/businessAnaly/exceprecord" class="friends-color">异常记录</a></li>
            ...
            <div class="content fr">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading no-collapse gk-title">异常记录</div>
...
<!--                     <div id="example-Czjl">
    ...
    <script src="<%=path%>/js/exceprecord.js"></script>
