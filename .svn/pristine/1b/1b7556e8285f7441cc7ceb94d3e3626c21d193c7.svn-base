...
public class DayActiveUserRetention {
	private String date;
	private int activeUserDay;
	...
	public int getActiveUserDay() {
		return activeUserDay;
	}
	public void setActiveUserDay(int activeUserDay) {
		this.activeUserDay = activeUserDay;
	}
	...
	public void setSixDay(double sixDay) {
		this.sixDay = sixDay;
	}
	...
	public double getFourteenDay() {
		return fourteenDay;
	}
	public void setFourteenDay(double fourteenDay) {
		this.fourteenDay = fourteenDay;
	}
	public double getThirtyDay() {
		return thirtyDay;
	}
	public void setThirtyDay(double thirtyDay) {
