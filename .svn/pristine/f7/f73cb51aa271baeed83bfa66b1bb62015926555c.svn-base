...
<body>
				...
				<ul class="parentWrap">
					...
					<li><span class="groupTitle"><s class="idx"><img
						...
						<ul class="friends">
							...
							<li><a href="<%=basePath%>rest/networkAndOper/networkAndOperView"
								" class="friends-color">运营商与网络</a></li>
						</ul></li>
					<li><span class="groupTitle"><s class="idx"><img
			...
			<div class="content fr">
				...
				<div class="users-dataTime">
					<div class="btn-Arr fl">
						<button type="button" class="bottuntab_left fl" id="oper">运营商</button>
						<div class="line fl"></div>
						<button type="button" class="bottuntab_right fl" id="network">联网方式</button>
					</div>
					<!-- Split button -->
					<div class="btn-group">
				...
				<div class="panel panel-default">
					<div class="panel-heading no-collapse gk-title" id="flag">运营商</div>
					<div class="timeAnaly-u">
						<div class="timeAnaly-btn">
							<div class="btn-group1 fl z" role="group">
								<button id="netAddUser" type="button" class="btn-left fl">新增用户</button>
								<div class="line fl"></div>
								<button id="netActUser" type="button" class="btn-center fl">活跃用户</button>
								<div class="line fl"></div>
								<button id="netStart" type="button" class="btn-right fl">启动次数</button>
							</div>
						</div>
						<div class="timeChart2" id='netEchart'></div>
					</div>
				</div>
				<!-- 第二排 -->
				<div class="panel panel-default">
					<div class="panel-heading no-collapse gk-title" id="netOrOper">运营商明细</div>
					<table id="queryNetOrOperTable" class="table-font table table-striped">
					</table>
				</div>
	...
	<script src="<%=basePath%>js/operOrNetwork.js"></script>
	<script type="text/javascript">
		$(".groupTitle").eq(1).next("ul").css("display", "block");
		$("#oper").addClass('bottuntab_left1');
		$("#netAddUser").addClass('btn-left1');
	</script>
</body>
